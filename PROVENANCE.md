...
- Release tag: ffmpeg/8.1.2-arcroom.6
...
| `tvos-arm64` | `appletvos` | `arm64-apple-tvos26.0` | tvos 26.0 |
| `tvos-arm64-simulator` | `appletvsimulator` | `arm64-apple-tvos26.0-simulator` | tvos 26.0 |
...
--prefix=/arcroom-ffmpeg \
  ...
  --enable-encoder=aac,eac3,h264_videotoolbox,movtext \
  --enable-parser=aac,aac_latm,ac3,dca,flac,mlp,opus,vorbis,h264,hevc \
  --enable-demuxer=matroska,mov,sup,webvtt \
...
- encoders: aac eac3 h264_videotoolbox movtext
- parsers: aac aac_latm ac3 dca flac mlp opus vorbis h264 hevc
- demuxers: matroska mov sup webvtt
- muxers: matroska mp4
- protocols: file
